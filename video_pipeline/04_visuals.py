...
Direction artistique constante (continuité) + sujet CONCRET de chaque phrase.
"""
import json
import os
import sys
...
# Direction artistique constante = continuité visuelle entre scènes
STYLE_NYAVODROID = (
...
def main():
    ...
    print(f"\n🖼️  [04_visuals] {len(scenes)} scènes (style premium cohérent)\n")
